...
export class RequestParser {
  ...
  parseListQueryParams(query: Record<string, unknown>): ListTodosQueryParams {
    return {
      ...
      ...(query.updatedAfter !== undefined && typeof query.updatedAfter === 'string' && { updatedAfter: query.updatedAfter }),
      ...(query.updatedBefore !== undefined && typeof query.updatedBefore === 'string' && { updatedBefore: query.updatedBefore }),
      ...(query.completedAfter !== undefined && typeof query.completedAfter === 'string' && { completedAfter: query.completedAfter }),
      ...(query.completedBefore !== undefined && typeof query.completedBefore === 'string' && { completedBefore: query.completedBefore }),
